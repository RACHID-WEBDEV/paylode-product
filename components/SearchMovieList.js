...
const SearchMovieList = () => {
  const { searchMoviesList, loading } = useSelector((state) => ({ ...state.searchMovies }))
    ...
    <>

      {
        loading === true ?
          ...
          </div> : <div className="grid grid-cols-1 gap-6 px-1 lg:px-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            {
